...
export function humanizeLuaSyntaxMessage(message: string): HumanizedScriptFailure | null {
...
export function humanizeLuaRuntimeMessage(message: string): HumanizedScriptFailure | null {
