...
export interface SceneManagerDomRefs {
    ...
    addTypeOpenBtn: HTMLButtonElement | null;
    addTypeSelectionCardEl: HTMLDivElement | null;
    addTypeCurrentIconEl: HTMLElement | null;
    addTypeCurrentEl: HTMLElement | null;
    addTypeCurrentTextEl: HTMLElement | null;
    addTypeEl: HTMLSelectElement | null;
    addTypeModalEl: HTMLDivElement | null;
    addTypeModalPreviewEl: HTMLDivElement | null;
    addTypeModalPreviewViewportEl: HTMLDivElement | null;
    addTypeModalPreviewTitleEl: HTMLDivElement | null;
    addTypeModalPreviewTextEl: HTMLDivElement | null;
    addTypeModalGridEl: HTMLDivElement | null;
    addTypeModalApplyBtn: HTMLButtonElement | null;
    addTypeModalSelectionCardEl: HTMLDivElement | null;
    addTypeModalSelectionIconEl: HTMLElement | null;
    addTypeModalSelectionTitleEl: HTMLElement | null;
    addTypeModalSelectionTextEl: HTMLElement | null;
    addTypeModalPrevBtn: HTMLButtonElement | null;
    addTypeModalNextBtn: HTMLButtonElement | null;
    addTypeModalCloseBtn: HTMLButtonElement | null;
    addTypeModalPageIndicatorEl: HTMLDivElement | null;
    addDictionaryWrapEl: HTMLLabelElement | null;
    addDictionaryEl: HTMLSelectElement | null;
    addValueWrapEl: HTMLLabelElement | null;
    ...
    selectedPointsWrapEl: HTMLLabelElement | null;
