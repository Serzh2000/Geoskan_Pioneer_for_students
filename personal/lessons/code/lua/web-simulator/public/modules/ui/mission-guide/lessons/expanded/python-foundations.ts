import { createStatementBlock } from '../support/builders.js';
import { compilePython } from '../support/compilers.js';
...
export function getPythonExpandedFoundationLessons(): GuideLesson[] {
    return [
        {
            id: 'py-led-confirm',
