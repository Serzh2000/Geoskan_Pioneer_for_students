...
export function recordExternalPythonBridgeEvent(payload) {
...
export function updateExternalPythonBridgeState(payload) {
    const state = {
        ...payload,
...
function parsePositionPayload(value) {
...
export function registerExternalPythonBridgeRoutes(app) {
