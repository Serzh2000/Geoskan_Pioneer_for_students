...
-- Поставить квадрокоптер, нажать кнопку запуска скрипта (квадрокоптер должен издать звуковой сигнал), 
-- Отойти на безопасное расстояние. Переключить тумблер SwA вниз, после запуска моторов поднять тумблер вверх. 
